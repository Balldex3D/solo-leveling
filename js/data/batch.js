export const BATCH_COOKING = {
  ...
  sabado: {
    ...
    tareas: [
      {
        texto: 'SÁBADO ALMUERZO — ARROZ FRESCO\n\n85 g de arroz blanco crudo (solo para el almuerzo de hoy).\n\n1. Mide 85 g de arroz\n2. En la arrocera con 102 ml de agua fría (proporción 1:1.2)\n3. Remueve y enciende\n4. Lista en ~15 min → rinde ~213 g cocido\n5. Usa fresco para el almuerzo\n\n⚠️ Este arroz NO viene del batch. Es fresco, cocínalo hoy.',
        timer_segundos: null
      },
      {
    ...
    almacenamiento: [
      '🍚 ARROZ — Cocina FRESCO el sábado almuerzo (85 g crudo → ~213 g cocido)',
