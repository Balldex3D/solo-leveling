export const RECETAS = {
  ...
  salmon_don: {
    ...
    pasos: [
      ...
      'Cocina el ARROZ FRESCO mientras se cocinan las otras cosas: En una ARROCERA, coloca 125 g de arroz blanco crudo. Agrega AGUA según las marcas de tu arrocera — normalmente es una proporción 1:1.2 a 1:1.5 (arroz:agua). Por ejemplo, 155 ml de agua. Enciende la arrocera. Ella misma cambiará a "Mantener caliente" cuando esté lista. El arroz rendirá aproximadamente 315 g cocido. ESTE ARROZ ES FRESCO, NO viene del batch.',
      'Cuando el salmón está listo (opaco en el centro), arma el bowl: En un bowl grande, coloca 315 g de arroz CALIENTE en la BASE. Encima del arroz, coloca la espinaca marchita. Encima de la espinaca, coloca el salmón entero o en 2-3 trozos grandes.',
  ...
  tofu_don_espinaca: {
    ...
    pasos: [
      ...
      'Recalienta el arroz (250 g cocido) del batch: En microondas 1-2 minutos (revolviendo a mitad de camino) o en sartén a fuego medio 2-3 minutos removiendo. Debe estar HUMEANTE (con vaho caliente saliendo).',
  ...
  sopa_miso_arroz_tofu: {
    ...
    pasos: [
      ...
      { texto: 'Recalienta el arroz (250 g cocido) del batch: Si es Miércoles o Sábado — saca del refrigerador y calienta en microondas 1 minuto o en sartén a fuego medio 2-3 minutos removiendo. Si es Domingo — saca del batch del miércoles y calienta igual. El arroz debe estar HUMEANTE.', timer_segundos: 180 },
