export const RECETAS = {
  okayu_miso_tamago: {
    ...
    pasos: [
      ...
      'PASO 3 — Arroz (AHORA, justo antes de armar): Saca 90 g de arroz de la arrocera. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo. Pásalo al bowl.',
  ...
  chicken_teriyaki_don: {
    ...
    pasos: [
      ...
      { texto: 'PASO 6: Pasa TODO el pollo con su salsa a un plato limpio. En la MISMA sartén (sin lavar, para aprovechar los sabores), agrega 50 g de espinaca. Lávala y sécala bien antes de usar. REVUELVE SIN PARAR 1 minuto a fuego MEDIO. La espinaca debe cambiar a verde oscuro brillante y verse marchita (más pequeña, blanda). No pases de 1 minuto o queda aguada.', timer_segundos: 60 },
      'PASO 7 — Arroz (hazlo AHORA, justo antes de armar el bowl): Saca 225 g de arroz de la arrocera. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo y HUMEANTE.',
  ...
  gyudon: {
    ...
    pasos: [
      ...
      'PASO 8 — Arroz (hazlo AHORA, justo antes de armar): Saca 225 g de arroz de la arrocera. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo.',
  ...
  egg_soboro_don: {
    ...
    pasos: [
      ...
      'Saca 225 g de arroz de la arrocera. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo y HUMEANTE.',
  ...
  tamagoyaki_don: {
    ...
    pasos: [
      ...
      'PASO 3 — Arroz (hazlo AHORA para que no se enfríe): Saca 200 g de arroz de la arrocera. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo. Pásalo al bowl grande.',
  ...
  salmon_don: {
    ...
    pasos: [
      ...
      'El arroz ya está listo en la arrocera desde la mañana (keep warm). Cuando el salmón esté listo, saca ~237 g directamente.',
  ...
  miso_udon_huevo: {
    ...
    pasos: [
      ...
      { texto: 'Agrega 40 g de espinaca fresca: lava, pica en trozos medianos y sécala bien con papel. Cocina 1 minuto más removiendo.', timer_segundos: 60 },
  ...
  tofu_don_espinaca: {
    ...
    pasos: [
      ...
      'Mientras escurre el tofu, prepara la espinaca: Es fresca — lava bien bajo agua fría, pica en trozos medianos (no demasiado pequeños o se deshacen) y sécala muy bien con papel de cocina.',
      ...
      { texto: 'Cuando termines el tofu, prepara la espinaca en la sartén Rena Ware PEQUEÑA: Ya está caliente si la usaste antes — si no, calienta 2 min a fuego MEDIO. Coloca 60 g de espinaca directamente (fresca: lávala y sécala bien antes de usar). Agrega 1/2 cucharadita de ghee. Mueve SIN PARAR durante 1 minuto, hasta que esté MARCHITA (verde oscuro brillante, más pequeña, blanda). No pases de 1 minuto o queda aguada.', timer_segundos: 60 },
      ...
      'Saca 188 g de arroz de la arrocera. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo y HUMEANTE.',
  ...
  sopa_miso_arroz_tofu: {
    ...
    pasos: [
      ...
      'Prepara la espinaca: Es fresca — lava bien bajo agua fría, pica en trozos medianos y sécala con papel de cocina.',
      ...
      { texto: 'Saca 188 g de arroz de la arrocera. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo y HUMEANTE.', timer_segundos: 180 },
