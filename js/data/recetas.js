export const RECETAS = {
  ...
  tamagoyaki_don: {
    ...
    pasos: [
      ...
      'PASO 3 — Arroz (hazlo AHORA para que no se enfríe): Saca 200 g de arroz cocido del batch. Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo. Pásalo al bowl grande.',
  ...
  tofu_don_espinaca: {
    ...
    pasos: [
      ...
      'Recalienta el arroz (188 g cocido) del batch: Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo y HUMEANTE.',
  ...
  sopa_miso_arroz_tofu: {
    ...
    pasos: [
      ...
      { texto: 'Recalienta el arroz (188 g cocido) del batch: Ponlo en la sartén Rena Ware pequeña. Agrega 3 cucharadas de agua fría. Tapa con un plato o tapa encima. Fuego MEDIO-BAJO 2-3 minutos. Cuando salga vapor por los bordes = listo y HUMEANTE.', timer_segundos: 180 },
