export const RECETAS = {
  okayu_miso_tamago: {
    ...
    pasos: [
      'PASO 1 — Miso: En una taza, pon 100 ml de agua. Calienta en el microondas 45 segundos. Agrega 10 g de pasta miso y revuelve con cucharita hasta que no queden grumos. Déjala a un lado.',
      ...
      'PASO 3 — Arroz (AHORA, justo antes de armar): Saca del batch 90 g de arroz cocido (la porción del desayuno de la nevera). Ponlo en el microondas en un bowl: calienta 1 minuto. Revuelve con cuchara. Si aún no sale vapor, 30 segundos más. Debe salir vapor caliente al acercarte.',
